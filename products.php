	...
	<div class="page products">
		<div class="content">
			<div class="block a">
				<div class="subheader">
					<div class="handle">
						<img class="shadow" src="imgs/44020b2e.jpg" alt="The Canadian Maple" />
					</div>
				</div> <!-- subheader -->
				<div class="cluster">
			...
			<div class="block b">
				...
				<div class="pieces">
					...
					<div class="piece web">
						<a href="product.php">
							<img src="imgs/c1049962.jpg" alt="Moorpark Apricots and Jam" />
							<h3>Sour Cherries In July</h3>
						</a>
					</div> <!-- piece -->
					<div class="piece web">
						<a href="product.php">
							<img src="imgs/9fa9a52c.jpg" alt="Moorpark Apricots and Jam" />
							<h3>Moorpark Apricots and Jam</h3>
						</a>
					</div> <!-- piece -->
				</div> <!-- pieces -->
